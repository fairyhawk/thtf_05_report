...
public class InstockDetailDto extends BaseDto {
    ...
    /** 入库总金额合计 */
    private String instockTotalmoneySum;
    /** 入库金额合计 */
    private String instockMoneySum;
    /** 返厂金额合计 */
    private String backMoneySum;
    /** 实际入库金额合计 */
    private String stockMoneyRelSum;
    /** 指定金额合计 */
    private String appointMoneySum;
    /** 未付款金额合计 */
    private String nonPaymentMoneySum;
    /** 收票金额合计 */
    private String receiveInvoiceMoneySum;
    /** 权限id */
    private int roleId;
    /** 用户id*/
