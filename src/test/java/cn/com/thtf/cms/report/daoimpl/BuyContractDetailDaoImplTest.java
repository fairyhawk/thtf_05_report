 ...
 * 
 */
public class BuyContractDetailDaoImplTest extends BaseTestNG implements NeedDBUnit {

    private RBuyContractDetailDao rBuyContractDetailDao = null;
    ...
    @BeforeClass
    public void setUp() {
        rBuyContractDetailDao = Container.getBean("rBuyContractDetailDao",
    ...
    public void testBuyContractDaoImpl012() {
        ...
        queryParam.setQuery(entity);
        RBuyContractDetailDto entitys = rBuyContractDetailDao
    ...
    private void testData(BaseQueryData<RBuyContractDetailEntity> queryParam) {
        List<RBuyContractDetailEntity> entitys = rBuyContractDetailDao
