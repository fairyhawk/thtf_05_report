 ...
 * 
 */
public class DynamicStocktakeDaoImpl extends BaseTestNG implements NeedDBUnit {

    public RDynamicStocktakeDao rDynamicStocktakeDao = null;
    ...
    @BeforeClass
    public void setUp() {
        rDynamicStocktakeDao = Container.getBean("rDynamicStocktakeDao",
    ...
    private void testData(BaseQueryData<RDynamicStocktakeEntity> queryParam) {
        List<RDynamicStocktakeEntity> entitys = rDynamicStocktakeDao
